export default {
  ...
  'pages.login.failure': 'Đăng nhập thất bài. Xin hãy thử lại!',
  'pages.login.400': 'Tài khoản hoặc mật khẩu không được để trống',
  'pages.login.404': 'Sai tài khoản hoặc mật khẩu. Vui lòng nhập lại',
